                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text('Full Card',
                          style: TextStyle(
                              fontSize: 24 - MediaQuery.of(context).size.width * (notifier.progress * 0.05), fontWeight: FontWeight.bold)),
                      SizedBox(
                      ...
                      AnimatedPadding(
                        ...
                        child: Text('Rotate the card to view the security code',
                            style: TextStyle(fontSize: 14 - MediaQuery.of(context).size.width * (notifier.progress * 0.05))),
                      ),
                    ],
                  ),
                ),
